...
*[[http://orgmode.org/][Org-mode]]* is an Emacs mode originally designed to make it easier to
 ...
 This document was written as a plain-text =.org= file and the raw
 version is available to look at. 
...
such as [[http://subversion.tigris.org/][Subversion]], [[http://www.selenic.com/mercurial/][Mercurial]] and [[http://git.or.cz/][Git]] can, if needed, manage very
large projects with many branches spread across multiple users. As
such, they require a little time to get comfortable with, mostly
because you have to get used to some new concepts related to tracking
your files, and then learn how your version control system implements
these concepts. Because of their power, these tools might seem like
overkill for individual users. (Again, though, many people find Word's
``Track Changes'' feature indispensable once they begin using it.) But
version control systems can be used quite straightforwardly in a basic
fashion, and they increasingly come with front ends that can be easily
integrated with your text editor.[fn:magit]
...
** Pulling Everything Together: An Emacs Starter Kit for the Social Sciences 
Detailed instructions for downloading and installing every piece of
...
mentioned above. It was [[https://github.com/eschulte/emacs-starter-kit][modified and further extended]] by Eric Schulte,
the author of Org-babel.  which smooths out Emacs' default settings to
make your life much easier. [[https://github.com/kjhealy/emacs-starter-kit][My version]] adds support for AucTeX, ESS,
and other bits and pieces mentioned here. As you can see if you follow
the links, the kit is stored on GitHub and you are free to fork it and
...
[[http://smultron.sourceforge.net/][Smultron]], and [[http://macromates.com/][TextMate]] (shown in Figure \ref{fig:tm}). I strongly
recommend taking a look at TextMate: it's the editor I use for most of
my day-to-day work. It has strong support for LaTeX and good (meaning,
ESS-like) support for R. Because it is a modern application written
specifically for the Mac it can take advantage of features of OS X
that Emacs cannot, and is much better integrated with the rest of your
system. It has good support for many of the ancillary applications
discussed above, such as version control systems.[fn:tm2] On Linux, an
...
the basic functionality of operating systems. The excellent [[https://www.getdropbox.com/][DropBox]],
...
automatically version-controls the contents of these folders (using
Subversion behind the scenes). DVCSs like Git and Mercurial combine
the virtues of version control and backups because every repository is
a complete, self-contained, cryptographically signed copy of the
project, which makes it easy to keep multiple copies of your work at
different locations.
