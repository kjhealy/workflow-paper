...
#+source: latex-example
#+CAPTION: A fragment of an earlier version of this document, written in LaTeX markup.
#+LABEL: fig:latex
...
*[[http://www.gnu.org/software/auctex/][AUCTeX]]* and *RefTeX* are bundled along with Emacs. These packages
...
\textcite{venables02:_moder_applied_statis_s_plus},
\textcite{maindonald03:_data_analy_graph_using_r},
\textcite{fox02:_r_s_plus_compan_applied_regres},
\textcite{frank01:_regres_model_strat}, and
\textcite{gelmanhill07:data_analysis}. Although it is a command-line
tool at its core, it has a good graphical interface as well. You can
download it from [[http://www.r-project.org/][The R Project Homepage]].
...
the normal way. It's pretty straightforward in practice. I've included
an example at the end of this document that shows how it works. Sweave
comes built-in to R. Sweave files can be edited in Emacs, as ESS
understands them.
...
time. You can work around this by designing projects so that they are
relatively modular, which is good practice anyway. The add-on package
=cacheSweave=, available from the R website, does a good job
...
#+CAPTION: Editing an earlier version of this document in TextMate (left) with the typeset output on the right. Note how section titles, citations and hyperlinks are represented in the editor and how they appear in the typeset document.  
#+LABEL: fig:textmate
#+ATTR_LaTeX: scale=0.2, placement=[h!]
[[file:figures/TextMateLaTeX.png][/Users/kjhealy/Documents/projects/teaching/workflow/figures/TextMateLaTeX]]
...
[[http://www.barebones.com/products/bbedit/index.shtml][BBEdit]] (beloved of many web developers), [[http://smultron.sourceforge.net/][Smultron]] and [[http://macromates.com/][TextMate]]. I
