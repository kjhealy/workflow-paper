...
these and more tools below. First, let's begin with a brief discussion
...
with many branches spread across multiple users. Git has become a the
...
your text editor.[^6] Moreover, you can meet these systems half way.
The excellent [DropBox](https://www.getdropbox.com/), for example,
