...
hard to learn. However, you don't have to start out using all of them
at once, or learn everything about them right away---the only thing
you *really* need to start doing immediately is keeping good backups.
There are a number of ways to try them out in whole or in part. You
could try writing something in Markdown first, using any editor. You
could begin using R with [RStudio](http://rstudio.com), which also
makes writing in RMarkdown very easy.[^8] Revision control is more
