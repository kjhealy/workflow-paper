...
\fvset{frame=single}
\setsansfont[Mapping=tex-text, BoldFont={Unit-Bold}, ItalicFont={Unit-Regular}]{Unit-Bold} 
\setmonofont[Mapping=tex-text,Scale=MatchLowercase]{PragmataPro} 
\setromanfont[Mapping=tex-text,Numbers=OldStyle]{Minion Pro} 
\chapterstyle{article-4-sans}
\setkeys{Gin}{width=1\textwidth} \pagestyle{kjh} \title{\bigskip
...
\href{http://kieranhealy.org/files/misc/workflow-apps.pdf}{\texttt{http://kieranhealy.org/files/misc/workflow-apps.pdf}}. The source file is available at \href{https://github.com/kjhealy/workflow-paper}{\texttt{https://github.com/kjhealy/workflow-paper}}.}
\maketitle \thispagestyle{kjhgit}
#+END_LaTeX

#+begin_abstract 
womble As a beginning graduate student in the social sciences, what
...
#+begin_src tex :exports code
  \subsection{Edit Text} This is what \textbf{LaTeX} is for. LaTeX is
...
#+begin_src r :exports code
  ...
  exploratory analysis of the data. We begin by reading in the data
  ...
  @ % now we are back to normal latex This concludes the exploratory
  analysis.
#+end_src
...
#+CAPTION: Editing the =.org= source of this document in an Emacs configured with the Starter Kit.
#+LABEL:   fig:emacsorg
