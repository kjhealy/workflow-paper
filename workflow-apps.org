...
Then the figure can be created directly. I don't show the code for
this here, but you can look in the [[https://github.com/kjhealy/workflow-paper][source file for this article]] to see
how it's done. 
