...
#+LATEX_CMD: xelatex
#+LATEX_HEADER: \setsansfont[Mapping=tex-text, BoldFont={Unit-Bold}, ItalicFont={Unit-Medium}]{Unit-Bold}
...
\url{kjhealy@soc.duke.edu}. Address: Sociology Dept, Duke
University, Durham, NC 27708, USA. I thank Jake Bowers for helpful
