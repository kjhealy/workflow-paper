...
\begin{figure}[h]
	\centering
		\includegraphics[scale=0.25]{figures/gitnub}
	\caption{Using gitnub, an OS X utility designed to make git easier to use, showing part of the revision history of this document.}
	\label{fig:gitnub}
\end{figure}
